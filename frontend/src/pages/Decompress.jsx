...
const Decompress = () => {
  ...
  const handleDecompress = async () => {
    ...
    try {
      const decompressedBlob = await decompressFile(file);
    ...
    <div className="pt-32 pb-20 px-6 min-h-screen">
      <div className="max-w-4xl mx-auto">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-4">Restore Your Files</h1>
            ...
            <GlassCard className="min-h-[400px] flex flex-col items-center justify-center border-dashed border-2 border-white/10 relative">
              ...
              {!file ? (
                <div className="text-center pointer-events-none">
                  ...
                  <h3 className="text-xl font-bold mb-2">Upload Compressed File</h3>
                ...
                <div className="text-center w-full px-12">
                  ...
                  {isDecompressing ? (
                    <div className="w-full max-w-xs mx-auto">
                      ...
                      <p className="text-xs text-gray-500 mt-2 font-mono">RECONSTRUCTING BITS... {progress}%</p>
                    </div>
                  ) : isDone ? (
                    <motion.div 
                    ...
                    <div className="flex flex-col items-center gap-4">
                      ...
                      <button onClick={() => setFile(null)} className="text-gray-500 hover:text-white text-sm">
                        Cancel
                      </button>
                    </div>
                  )}
