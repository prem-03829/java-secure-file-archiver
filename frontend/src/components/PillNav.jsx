      ...
      >
            ...
            {items.map((item, i) => {
              ...
              const PillContent = (
                <>
                  ...
                  {isActive && (
                    <span
                      className="absolute left-1/2 -bottom-[2px] -translate-x-1/2 w-1 h-1 rounded-full z-[4]"
              ...
              const basePillClasses =
                'relative overflow-hidden inline-flex items-center justify-center h-full no-underline rounded-full box-border font-bold text-[12px] leading-[0] uppercase tracking-[0.5px] whitespace-nowrap cursor-pointer px-0';
        ...
        >
          <span
            ...
            style={{ background: 'var(--pill-bg, #060010)' }}
          />
          <span
            className="hamburger-line w-4 h-0.5 rounded origin-center transition-all duration-[10ms] ease-[cubic-bezier(0.25,0.1,0.25,1)]"
            style={{ background: 'var(--pill-bg, #060010)' }}
        ...
        <ul className="list-none m-0 p-[3px] flex flex-col gap-[3px]">
          {items.map(item => {
            ...
            const hoverIn = (e) => {
              ...
              e.currentTarget.style.color = 'var(--hover-text, #060010)';
            };
            const hoverOut = (e) => {
              e.currentTarget.style.background = 'var(--pill-bg, #060010)';
